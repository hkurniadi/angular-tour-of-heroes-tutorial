...
var forms_1 = require("@angular/forms"); // <-- where ngModel directive lives
var app_routing_module_1 = require("./app-routing.module"); // <-- separate the routing config in another files
var http_1 = require("@angular/http"); // <-- provides the HTTP services
